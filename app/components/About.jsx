    ...
    >
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
        <div className="md:w-1/2 relative w-full h-96 group">
          <div className="absolute inset-0 bg-blue-400 rounded-2xl blur-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-500"></div>
          <Image
            src="/image.png"
            alt="Designer Solutions moving truck in Tucker GA"
            fill
            className="object-cover rounded-2xl shadow-2xl brightness-110 relative z-10 transition-transform duration-500 group-hover:scale-[1.02]"
            priority
          />
        </div>
        <div className="md:w-1/2">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-blue-900 tracking-tight">
          ...
          <div className="w-full max-w-2xl overflow-hidden rounded-2xl border border-gray-200 shadow-xl bg-white/80 backdrop-blur-sm p-2">
            <iframe
