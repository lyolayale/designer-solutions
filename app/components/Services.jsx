...
//           className="w-full flex items-center justify-center gap-2 text-blue-900 font-semibold hover:text-blue-700 transition-colors text-left"
//         >
//           <span>{isOpen ? "Hide Details" : `More about ${service.title}`}</span>
...
function ServiceCard({ service, index, openCard, toggleCard }) {
  ...
  return (
    /* h-full stretches the card container to match the CSS Grid row height */
    <div className="w-full h-full bg-white rounded-lg shadow-md overflow-hidden flex flex-col">
      ...
      {/* Card Content: flex-1 ensures it pushes everything to match parent height */}
      <div className="p-5 text-center flex flex-col flex-1">
        ...
        {/* Dropdown Button: mt-auto pins this action block to the bottom of the card content area */}
        <div className="mt-auto">
          <button
            type="button"
            onClick={() => toggleCard(index)}
            className="w-full flex items-center justify-center gap-2 text-blue-900 font-semibold hover:text-blue-700 transition-colors"
          >
  ...
  return (
    <section id="services" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        {/* SERVICES GRID */}
        {/* ============================= */}
        {/* Replacing manual flex column wraps with grid structure ensures row alignment */}
